...
if (!window.CONFIG) {
    window.CONFIG = {
        ...
        CLIENT_ID: 'ColorWeb',
        COMMUNITY_GUIDELINES_ENDPOINT: 'https://kuler.adobe.com/community-guidelines',
        ...
        UTILITY_NAV: 'https://prod.adobeccstatic.com/utilnav/8.2/utilitynav.js',
        UTILITY_NAV_CSS: 'https://prod.adobeccstatic.com/utilnav/8.2/utilitynav.css',
